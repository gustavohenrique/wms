...
#class HiddenField(fields.CharField):
#    def clean(self, value):
#        super(fields.CharField, self).clean(value)

#from wms.custom import TextField
import custom
...
class ExtJSONEncoder(DjangoJSONEncoder):
    ...
    DJANGO_EXT_FIELD_TYPES = {
        ...
        custom.TextField: ["Ext.form.TextArea", TEXTAREA_EDITOR],
    }
